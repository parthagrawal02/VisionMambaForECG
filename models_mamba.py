...
def vim_base_ecg(pretrained=False, **kwargs):
    model = VisionMamba(
        patch_size=(1, 40), embed_dim=192, depth=24, rms_norm=True, residual_in_fp32=True, fused_add_norm=True, final_pool_type='mean', if_abs_pos_embed=True, if_rope=False, if_rope_residual=False, bimamba_type="v2", **kwargs)
